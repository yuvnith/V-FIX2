...
public class ComputerActivity extends Activity {
    ...
    String insertUrl="http://192.168.1.9/android_login_api/computer.php";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Fullname=(EditText) findViewById(R.id.Cmname);
        Email=(EditText)findViewById(R.id.Cmemail);
        Address=(EditText)findViewById(R.id.Cmaddress);
        Phone=(EditText)findViewById(R.id.Cmphone);
        Date=(EditText)findViewById(R.id.Cmdate);
        Time=(EditText)findViewById(R.id.Cmtime);
        Book=(Button)findViewById(R.id.Cmbook);
        ...
        Book.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                if (!name.isEmpty() && !email.isEmpty() && !address.isEmpty() && !phone.isEmpty() && !date.isEmpty() && !time.isEmpty())
                {
                    ...
                    if(isValidEmail(email))
                    {
                        if(phone.length()>=10 && phone.length()<=12)
                        {
                            if (phone.matches("^[789]\\d{9}$"))
                            {
                                ...
                                {
                                    Toast.makeText(getApplicationContext(),
                                            "enter a proper small name", Toast.LENGTH_LONG)
                                            .show();
                                }
    ...
    private void Bookuser(final String name, final String email,final String phone,
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST,
            ...
            protected Map<String, String> getParams() {
                ...
                params.put("cmname", name);
                params.put("cmemail", email);
                params.put("cmaddress", address);
                params.put("cmphone", phone);
                params.put("cmdate", date);
                params.put("cmtime", time);
