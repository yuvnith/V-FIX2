...
public class ElectricianActivity extends Activity {
    ...
    String insertUrl="http://192.168.1.9/android_login_api/electrician.php";


    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_electician);

        Fullname=(EditText) findViewById(R.id.Ename);
        ...
        Book=(Button)findViewById(R.id.Ebook);
