...
public class AcrepairActivity extends Activity {
    ...
    String insertUrl="http://192.168.1.9/android_login_api/acrepair.php";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Fullname=(EditText) findViewById(R.id.Aname);
        ...
        Time=(EditText)findViewById(R.id.Atime);
        Book=(Button)findViewById(R.id.Abook);
    ...
    private void Bookuser(final String name, final String email
                          ,final String address, final String phone ,final String date,final String time) {
