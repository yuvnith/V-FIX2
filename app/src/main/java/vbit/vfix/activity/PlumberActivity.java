...
public class PlumberActivity extends Activity {
    ...
    String insertUrl="http://192.168.1.9/android_login_api/plumber.php";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Fullname=(EditText) findViewById(R.id.Plname);
        Email=(EditText)findViewById(R.id.Plemail);
        Address=(EditText)findViewById(R.id.Pladdress);
        Phone=(EditText)findViewById(R.id.Plphone);
        Date=(EditText)findViewById(R.id.Pldate);
        Time=(EditText)findViewById(R.id.Pltime);
        Book=(Button)findViewById(R.id.Plbook);
    ...
    private void Bookuser(final String name, final String email,final String phone,
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST,
            ...
            protected Map<String, String> getParams() {
                ...
                params.put("plname", name);
                params.put("plemail", email);
                params.put("pladdress", address);
                params.put("plphone", phone);
                params.put("pldate", date);
                params.put("pltime", time);
