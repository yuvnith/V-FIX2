...
public class CarpenterActivity extends Activity {
    ...
    String insertUrl="http://192.168.1.9/android_login_api/carpenter.php";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Fullname=(EditText) findViewById(R.id.Cname);
        ...
        Time=(EditText)findViewById(R.id.Ctime);
        Book=(Button)findViewById(R.id.Cbook);
